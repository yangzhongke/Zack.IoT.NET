...
{
    /// <summary>
    /// modified from Large4Digit7SegmentDisplay.cs
    /// </remarks>
    public partial class My7Segment : Ht16k33, ISevenSegmentDisplay
    {
        ...
        private enum Address
        {
            ...
            /// Third digit
            /// </summary>
            Digit3 = 10,//modified by zack yang, bug of CrowPI2

            /// <summary>
            /// Fourth digit
            /// </summary>
            Digit4 = 7//modified by zack yang, bug of CrowPI2
        }
        #endregion
        ...
        {
            return (int)s_digitAddressList[digit];
        }
        ...
        public My7Segment(I2cDevice i2cDevice)
            : base(i2cDevice)
        {
        }
